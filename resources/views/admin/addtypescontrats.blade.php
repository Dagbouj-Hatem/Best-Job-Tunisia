...
<html lang="fr">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Types de contrats</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item active" href="/admin/dashboard/typescontrats/add"><i class="icon fa fa-plus-square"></i> Ajouter un type de contrat</a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>Ajouter un type de contrat</h1>
          <p>Saisie les informations suivantes</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Types de contrats</li>
          <li class="breadcrumb-item"><a href="#">Ajouter un type de contrat</a></li>
        </ul>
      </div>
      <div class="row"> 
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Type de contrat</h3>
            <div class="tile-body">
              <form class="row" method="POST" action="{{ url('admin/dashboard/typescontrats/save') }}"> 
                 {{ csrf_field() }} 
