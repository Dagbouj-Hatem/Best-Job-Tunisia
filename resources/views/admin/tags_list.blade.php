...
<html lang="fr">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Mots clés</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item active" href="/admin/dashboard/tags"><i class="icon fa fa-list-ul"></i>Liste des mots clés</a></li>
          </ul>
        </li>
 ...
 <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Mots clés</h1>
          <p> la liste des mots clés</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Tableau de bord</li>
          <li class="breadcrumb-item active"><a href="#"> Mots clés</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
                ...
                @foreach($tags as $tag) 
                  <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('deletetags',  $tag->id) }}" class="btn btn-danger btn-sm">
                        Supprimer
                      </a> 
                    </td>
                  </tr>
