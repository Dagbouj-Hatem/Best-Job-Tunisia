...
<html lang="fr">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item active" href="/admin/dashboard/"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Tableau de bord</span></a></li> 
...
<img src="{!! asset('admin/images/background.jpg') !!}" class="img-fluid">
 </main>
