...
<html lang="fr">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Catégories</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item active" href="/admin/dashboard/categories"><i class="icon fa fa-list-ul"></i>Liste des catégories</a></li>
          </ul>
        </li>
 ...
 <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Catégories</h1>
                ...
                @foreach($categories as $categorie) 
                  <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('deletecategories',  $categorie->id) }}" class="btn btn-danger btn-sm">
                        Supprimer
                      </a> 
                    </td>
                  </tr>
