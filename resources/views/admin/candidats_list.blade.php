...
<html lang="fr">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Candidats</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item active" href="/admin/dashboard/candidats"><i class="icon fa fa-list-ul"></i>Liste des candidats</a></li>
          </ul>
        </li>
 ...
 <main class="app-content">
    <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Candidats</h1>
          <p> la liste des candidats</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Tableau de bord</li>
          <li class="breadcrumb-item active"><a href="#"> Candidats</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile-body">
              <table class="table table-hover table-bordered" id="sampleTable">
               <thead>
                ...
                <tbody>
                @foreach($candidats as $admin) 
                  <tr> 
                    <td>{{ $admin->id }}</td>
                    <td>{{ $admin->name }}</td>
                    <td>{{ $admin->prenom }}</td>
                    <td>{{ $admin->email }}</td> 
                    <td>@if(isset($admin->cv))
                      <a href="{{ isset($admin->cv) ? asset('CVs/'.$admin->cv) : '#' }}">Télécharger CV</a>
                      @endif
                    </td> 
                    <td class="text-center">
                        <a href="{{ route('deletecandidat',  $admin->id) }}" class="btn btn-danger btn-sm">
                        Supprimer
                      </a> 
                    </td>
                  </tr>
