...
<html lang="fr">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Entreprises</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item active" href="/admin/dashboard/entreprises"><i class="icon fa fa-list-ul"></i>Liste des entreprises</a></li>
          </ul>
        </li>
 ...
 <main class="app-content">
    <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Entreprises</h1>
          <p> la liste des entreprises</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Tableau de bord</li>
          <li class="breadcrumb-item active"><a href="#"> Entreprises</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
              ...
              <table class="table table-hover table-bordered" id="sampleTable">
               <thead>
                ...
                @foreach($entreprises as $entreprise) 
                  <tr>
                    <td><img class="img-fluid" src="{{ isset($entreprise->photo) ? asset('logo_entreprises/'.$entreprise->photo) :  asset('entreprise/images/no-photo.png')  }}" alt="User Image" width="48" height="48"></td>
                    <td>{{ $entreprise->id }}</td>
                    ...
                    <td class="text-center">
                        <a href="{{ route('deleteentreprises',  $entreprise->id) }}" class="btn btn-danger btn-sm">
                        Supprimer
                      </a> 
                    </td>
                  </tr>
