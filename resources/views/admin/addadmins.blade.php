...
<html lang="fr">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>Ajouter un administrateur</h1>
          <p>Saisie les informations suivantes</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Administrateurs</li>
          <li class="breadcrumb-item"><a href="#">Ajouter un administrateur</a></li>
        </ul>
      </div>
      <div class="row"> 
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Administrateur</h3>
            <div class="tile-body">
              <form class="row" method="POST" action="{{ url('admin/dashboard/admins/save') }}"> 
                 {{ csrf_field() }}
                <div class="form-group offset-md-4 col-md-4">
                  <label class="control-label">Nom</label>
                  <input class="form-control {{ $errors->has('nom') ? 'is-invalid' : '' }}" type="text" placeholder="Nom" name="nom" value="{{ old('nom') }}">
                </div>
                 <div class="form-group offset-md-4 col-md-4">
                  <label class="control-label">Prénom</label>
                  <input class="form-control {{ $errors->has('prenom') ? 'is-invalid' : '' }}" type="text" placeholder="Prénom" name="prenom" value="{{ old('prenom') }}">
                </div>  
                <div class="form-group  offset-md-4 col-md-4">
                  <label class="control-label">Email</label>
                  <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" placeholder="Email" name="email" value="{{ old('email') }}">
                </div>  <div class="form-group offset-md-4 col-md-4">
                ...
                <div class="form-group col-md-12 align-self-end text-center">
