...
@section('content') 
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Ajouter un offre d'emploi</h1>
          <p>SVP saisissez les informations suivantes</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Offres</li>
          <li class="breadcrumb-item"><a href="#">Ajouter un offre</a></li>
        </ul>
      </div>
      <form method="POST" action="{{ url('entreprise/offres/add') }}">
         {{ csrf_field() }}
              ...
              <div class="col-lg-5 offset-lg-1"> 
                  ...
                  <div class="form-group"> 
                      ...
                      <div class="input-group"> 
                            <input class="form-control  {{ $errors->has('salaire') ? 'is-invalid' : '' }}" id="readOnlyInput" type="text" placeholder="Salaire" name="salaire" value="{{ old('salaire') }}">
                  ...
                  <div class="form-group has-danger">
                    ...
                    <textarea class="form-control  {{ $errors->has('exigence') ? 'is-invalid' : '' }} " id="inputInvalid"  placeholder="Exigence " name="exigence">{{ old('exigence') }}</textarea>
                  </div>
                  <div class="form-group">
                    <label class="col-form-label" for="inputLarge">Expériance</label>
                    <input class="form-control  {{ $errors->has('experiance') ? 'is-invalid' : '' }}" id="inputLarge" type="text" name="experiance" value="{{ old('experiance') }}">
                  </div>
                  <div class="form-group">
