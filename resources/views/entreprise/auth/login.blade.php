...
<html>
  ...
  <body>
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form class="login-form" method="POST" action="{{ url('/entreprise/login') }}">
             {{ csrf_field() }}
          ...
          <div class="form-group" style="margin-top: 20px;">
            <div class="utility">
              <div class="animated-checkbox">
                <label>
                  <p class="semibold-text mb-2"><a href="{{ url('entreprise/password/reset') }}" data-toggle="flip">Mot de passe oublier?</a></p>
                </label>
              </div>
